<?php
  class CropAvatar {
    ...
    private $type;
    private $extension;
    private $srcDir = 'img/crop/upload';
    private $dstDir = 'img/crop/avatar';
    private $msg;
    ...
    private function setFile($file) {
      ...
      if ($errorCode === UPLOAD_ERR_OK) {
        ...
        if ($type) {
          ...
          // Definindo o nome da imagem do avatar
    ...
    private function crop($src, $dst, $data) {
      if (!empty($src) && !empty($dst) && !empty($data)) {
        ...
        if ($result) {
          ...
          if (imagepng($dst_img, $dst)) {
            unlink($src); // Isso apaga a imagem original da pasta 'img/crop/upload'
          }
